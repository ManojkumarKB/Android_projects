...
import com.example.couplecalc.di.Module.CalcModule
import com.example.couplecalc.di.Module.LoginModule
import dagger.Component
import javax.inject.Singleton

@Component(modules = [LoginModule::class, AuthModule::class, AppModule::class, CalcModule::class])
@Singleton
interface AppCompon
{
    fun inject(activity: MainActivity)

    fun CalcComponent(): CalcComponent.Builder
}